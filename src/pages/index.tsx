...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{` I.N.V.O.K.E.`}</title>

        <meta
          name="description"
          content="Welcome to I.N.V.O.K.E., your intelligent multi-agent framework designed for collaborative goal achievement. Leverage domain-specific intelligent agents, enjoy real-time communication, self-reflection, user feedback and revolutionize the way you achieve your goals. With advanced features and robust security, I.N.V.O.K.E. offers a scalable, reliable and intelligent solution for your Next.js web applications."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517048676732-d65bc937f952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb2xsYWJvcmF0aW9ufGVufDB8fHx8MTY5OTc3NTMwNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to I.N.V.O.K.E., your intelligent multi-agent framework designed for collaborative goal achievement. Leverage domain-specific intelligent agents, enjoy real-time communication, self-reflection, user feedback and revolutionize the way you achieve your goals. With advanced features and robust security, I.N.V.O.K.E. offers a scalable, reliable and intelligent solution for your Next.js web applications.`}
            </Text>
            <Box
