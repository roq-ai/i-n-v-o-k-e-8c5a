...
import { useGoalFindFirst, useRoqClient } from 'lib/roq';
...
function GoalViewPage() {
  ...
  const { data, error, isLoading } = useGoalFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('goal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/goals/edit/${id}`} passHref legacyBehavior>
                    <Button
