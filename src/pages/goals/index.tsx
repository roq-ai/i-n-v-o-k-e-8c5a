...
import { useRoqClient, useGoalFindManyWithCount } from 'lib/roq';
...
export function GoalListPage(props: GoalListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useGoalFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.goal.delete({ where: { id } });
      await mutate();
    } catch (error) {
