...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'intelligent-agent', 'system-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Goals', path: '/goals', entity: 'goal', service: AccessServiceEnum.PROJECT, icon: FiTarget },
    {
